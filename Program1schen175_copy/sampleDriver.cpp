  ...
  */
  {
    ...
    // test first/rest
     ...
     // Sentence s2("Okay just checking.");
    // std::cout << s1.first() << std::endl;
     
    // std::cout << s1.rest() << std::endl;
    // Paragraph p1((hello+cs240) + s1 + s2);
    // std::cout << p1 << std::endl;
    // std::cout << p1.first() << std::endl;
    // std::cout << p1.rest() << std::endl;
    // std::cout << restHelper(p1) << std::endl;
    // Story story("out2.txt");
    // std::cout << story.first() << std::endl;
    // std::cout << p1 + story.rest() << std::endl;
    // std::cout << restHelper(story) << std::endl;
    // std::cout << story.rest() << std::endl;
  }
